...
// Exibe todos os valores encontrados
	...
	"<td>".$value->tblUsuario_nome."</td><td>".$value->tblUsuario_email."</td>".
	 ...
	 "<td><button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal'>Alterar</button></td>".
	 "<td><button type='button' class='btn btn-danger' name='excluir_ui' onclick='fn_exluir(".$value->tblUsuario_id.");' >Excluir</button></td>".
	 "</tr>";
}
// Acentuação
